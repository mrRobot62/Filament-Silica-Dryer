...
namespace UI
{
  ...
  constexpr int TXT_SIZE = 2; // Content
  constexpr int FTR_SIZE = 1; // Footer

  // Header
  constexpr int HDR_H = 30;
  constexpr int HDR_Y = 22; // baseline für "STATUS"
  constexpr int HDR_LINE_Y = 34;

  // Spalten
  constexpr int COL_W = LCD_WIDTH / 2;
  constexpr int COL1_X = 8;
  constexpr int COL2_X = COL1_X + COL_W;
  constexpr int ROW_Y0 = 48; // erste Zeile unter Header-Linie
  constexpr int ROW_DY = 24; // Zeilenabstand

  // Footer
  constexpr int FTR_H = 20;
...
static Cell cellTemp, cellHeater, cellMotor, cellFan12, cellFan230, cellFault;
