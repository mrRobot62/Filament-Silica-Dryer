...
| **P6**  | Heater Relay       |       0 V       |   **5 V** (Relais EIN)    | Heizung einschalten / Solltemp. unterschreiten | Beim Aktivieren klickt Relais; an Spule 5 V messbar.        |
...
| :--------------------------- | :------: | :-----------: | :----------------------------------------- |
| **Relais-Spule** (gegen GND) |   0 V    |     ~5 V      | Nur wenn Heizung EIN (P6=HIGH).            |
...
| :----: | :----------- | :------- | :---------- | :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **P6** | Heater Relay | Ausgang  | GND         | **HIGH = Relais an** | Treibt Transistor Q7. Das Relais zieht an, solange die Temperatur **unter Sollwert** liegt. Wird abgeschaltet, sobald die Zieltemperatur erreicht ist. |
...
|   Pin   | Funktion    | Richtung | Aktiv gegen | Aktivpegel                               | Beschreibung                                                                                                     |
| :-----: | :---------- | :------- | :---------- | :--------------------------------------- | :--------------------------------------------------------------------------------------------------------------- |
| **P12** | Door Switch | Eingang  | GND         | **LOW = geschlossen** / **HIGH = offen** | Mechanischer Schalter nach Masse. Intern mit Pull-Up auf +5 V. Sicherungsfunktion gegen Betrieb bei offener Tür. |
